...
class ReplySerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        return Reply.objects.create(post_id=post_id, comment_id=comment_id, user_id=user_id.id, **validated_data)
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ['id', 'user', 'post', 'description',
                  'replys', 'placed_at', 'updated_at']
